...
public class Main {
    ...
    static String className = fimus.Main.class.getName();
    ...
    public static void main(String[] args) {
        ...
        //call FIMUS
        double userThreshold=0.2; 
        FIMUS fimus=new FIMUS();
        fimus.runFIMUS(fileAttrInfo, fileDataFileIn, fileOutput,userThreshold);
